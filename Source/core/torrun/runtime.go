...
//
//	external — отдельный процесс tor (Windows, Linux, Android)
//	embedded — tor библиотекой в этом же процессе (iOS)
//	torlib   — сама библиотека для embedded: статический tor под Apple
//
